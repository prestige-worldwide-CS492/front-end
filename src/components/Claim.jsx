...
export default props => <div className="container">
  <ul className="breadcrumb">
    ...
    <li className="active">{props.uuid ?? '00000000-0000-0000-0000-000000000000'}</li>
  </ul>

  <div className="card row top">
    <h3>CLAIM {props.uuid ?? '00000000-0000-0000-0000-000000000000'}</h3>
    <h6 className="green">Submitted on {props.data ?? '3.28.2021'}</h6>
  </div>
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-4">
          ...
          <h2 style={{ marginBottom: '8px' }}>{props.name ?? 'Joe Smith'}</h2>
          <h5>{props.policy ?? '0-000-000-0000'}</h5>
        </div>
        
        <div className="col-md-4">
          <h6>Category of Claim</h6>
          <h2>{props.category ?? 'vehicle collision'}</h2>
        </div>
  ...
  <div className="card row">
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-4">
          <img className="img-responsive" src="https://maps.googleapis.com/maps/api/staticmap?center=Berkeley,CA&zoom=15&size=400x250&key=AIzaSyCV8Bi_rySUoaw2lTbwrTPdJUjZRnonGFk" />

          <h6 style={{ marginTop: '40px' }}>Date</h6>
          <h2>{props.address ?? '3.27.2021'}</h2>
