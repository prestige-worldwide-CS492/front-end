...
export default function Claim ({ match }) {
  ...
  useEffect(() => {
    fetch(`${location.hostname}:8080/claims/${match.params.claimID}`)
      .then(res => res.json())
    ...
    <div className='container'>
      ...
      <div className='card row'>
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-md-4'>
              <img className='img-responsive' alt='map' src={`${location.hostname}:8080/claims/map/${match.params.claimID}`} />
